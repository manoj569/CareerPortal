...
namespace JobPortal.Persistence.Migrations
{
    ...
    [Migration("20260729082045_AddCandidateProfilesResumesAndApplications")]
    partial class AddCandidateProfilesResumesAndApplications
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.PaymentHistory", b =>
                {
                    ...
                    b.HasIndex("ProviderEventId")
                        .IsUnique()
                        .HasFilter("[ProviderEventId] IS NOT NULL AND [IsDeleted] = 0");
